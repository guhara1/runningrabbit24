...
- **구조화 데이터(JSON-LD) — 전 페이지 공통 + 페이지별**
  ...
  - `Person` — 예약 총괄 매니저 (E-E-A-T 작성자), `WebPage` — 작성·갱신 일자
...
- **이용 시스템** → 시스템 안내 · 이용 요금 & 세트 · 단체 & 비즈니스 미팅 · 생일파티 & 회식 이벤트
...
> 본 사이트는 만 19세 이상 성인을 위한 정식 허가 업소 안내 페이지입니다.
